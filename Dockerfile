...
RUN yum install -y git cmake iproute hostname sysstat traceroute docker iftop net-tools sudo
...
RUN g++ -std=c++20 -O2 -DNDEBUG -I/asio/asio/include -I./libraries/crow/include/ -I. main2.cpp stats.cpp docker.cpp parse.cpp -o main2 -lpthread
